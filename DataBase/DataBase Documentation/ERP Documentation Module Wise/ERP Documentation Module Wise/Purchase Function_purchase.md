# Purchase Functions - Complete Documentation

**Category:** Purchase Functions
**Total Functions:** 12
...
#### Purpose:
Create Purchase - Creates a new record in the database with all related entries and accounting journal.
...
#### Purpose:
Update Purchase Invoice - Updates an existing record with validation to maintain data integrity.
...
### Function 3: `validate_purchase_update2()`
...
#### Purpose:
Delete Purchase - Deletes a record after validation, cleaning up all related entries.

#### Example SQL Call:

```sql
SELECT delete_purchase(...);
```
