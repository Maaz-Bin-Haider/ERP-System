...
--===================================================================================
-- ✅ 1. Purchase Serial Ledger (ONLY purchase price)
--===================================================================================
CREATE OR REPLACE FUNCTION public.get_serial_ledger_purchase(p_serial text) 
RETURNS TABLE(
    serial_number text, 
    serial_comment text,
    item_name text, 
...
$$;
--===================================================================================
-- ✅ 2. Sales Serial Ledger (ONLY sale price)
--===================================================================================
CREATE OR REPLACE FUNCTION public.get_serial_ledger_sales(p_serial text) 
RETURNS TABLE(
    serial_number text, 
    serial_comment text,
    item_name text, 
